...
import {
    ...
    phoneValidator,
    usernameValidator,
} from '@fuse/validators/custom-validator';
...
export class CreateManagerComponent implements OnInit {
    ...
    usernameMessage = AppMessages.usernameMessage;
    passwordMessage = AppMessages.passwordMessage;
    confirmPasswordMessage = AppMessages.confirmPasswordMessage;
    phoneMessage = AppMessages.phoneMessage;
    ...
    private initCreateManagerForm() {
        ...
        this.createManagerForm
            ...
            .setValidators([
                Validators.required,
                confirmPasswordValidator(
                    this.createManagerForm.get('password')
                ),
            ]);
    }
    ...
    public createManager() {
        if (this.createManagerForm.valid) {
            this._managerServive
                .createManager(this.createManagerForm.value)
                .subscribe(
                    (manager) => {
                        if (manager) {
